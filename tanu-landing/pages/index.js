  ...
  return (
    <div className="font-sans bg-background dark:bg-black text-foreground dark:text-white transition-colors duration-500">
        ...
        <div className="container mx-auto flex justify-between items-center px-6">
          ...
          <nav className="flex items-center space-x-4">
            ...
            <button
              ...
              className="ml-4 px-4 py-2 bg-primary text-black dark:text-white dark:bg-yellow-400 rounded hover:opacity-80 transition"
            >
      ...
      >
        ...
        <div
          key={i}
          className="absolute rounded-full opacity-100" // opacity-30 илүү subtle
          style={{
          width: `${p.size}px`,
          height: `${p.size}px`,
          top: `${p.y}%`,
          left: `${p.x}%`,
          backgroundColor: 'white', // Бүх бөмбөлөг цагаан
